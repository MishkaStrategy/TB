...
BUTTONS = {
    ...
    "❤️ Донат": "❤️ Donate",
    "🔔 Настройки FVG 15м": "🔔 FVG 15m settings",
    "🔕 Настройки FVG 15м": "🔕 FVG 15m settings",
    ...
    "🔎 Проверка фандинга": "🔎 Funding check",
    "🔎 Проверить другой": "🔎 Check another",
    "🔄 Показать актуальные": "🔄 Refresh",
    "⬅️ Главное меню": "⬅️ Main menu",
    "⬅️ Настройки": "⬅️ Settings",
    "7 дней": "7 days",
    "30 дней": "30 days",
    "Всё время": "All time",
    ...
    "👥 Разрешённые пользователи": "👥 Allowed users",
    "📡 WebSocket": "📡 WebSocket",
    "📨 Очередь уведомлений": "📨 Notification queue",
    "🗄 Базы данных": "🗄 Databases",
    "🖥 Память и нагрузка": "🖥 Memory and load",
    "💾 Резервная копия": "💾 Backup",
    "🏷 Версия релиза": "🏷 Release version",
    "♻️ Перезапустить бота": "♻️ Restart bot",
    "✅ Да, перезапустить": "✅ Yes, restart",
    "❌ Отмена": "❌ Cancel",
    "🌐 Доступ: публичный": "🌐 Access: public",
    "🔐 Доступ: приватный": "🔐 Access: private",
}
...
PHRASES = {
    ...
    "Панель управления FVG:": "FVG control panel:",
    ...
    "Спасибо за поддержку разработки и работы бота.": "Thank you for supporting the bot's development and operation.",
    "EVM-адрес:": "EVM address:",
    "Перед отправкой проверьте выбранную сеть.": "Check the selected network before sending.",
    ...
    "выключены": "disabled",
    "каждые": "every",
    "положительный и отрицательный": "positive and negative",
    "положительный": "positive",
    "отрицательный": "negative",
    "после включения — в ближайшую четверть часа": "after enabling — at the next quarter hour",
    "в ближайшую четверть часа": "at the next quarter hour",
    "после включения — в ближайшие :50": "after enabling — at the next :50",
    "в ближайшие :50": "at the next :50",
    "Общий снимок всех бирж обновляется каждые 15 минут.": "A shared snapshot of all exchanges is refreshed every 15 minutes.",
    "В базе остаются только три последних снимка.": "Only the three latest snapshots are retained in the database.",
    ...
    "Введите частоту уведомлений от 15 до 2880 минут.": "Enter an alert interval from 15 to 2880 minutes.",
    "Шаг — 15 минут. Примеры: 15, 30, 45, 60 или 1,5ч.": "Use a 15-minute step. Examples: 15, 30, 45, 60 or 1.5h.",
    "Введите частоту уведомлений целым числом от 1 до 48.": "Enter the alert frequency as an integer from 1 to 48.",
    "Частота должна быть от 15 минут до 48 часов с шагом 15 минут.": "The interval must be from 15 minutes to 48 hours in 15-minute steps.",
    "Нужно выбрать хотя бы одно направление.": "Select at least one direction.",
    "Введите порог фандинга в процентах положительным числом.": "Enter a positive funding threshold in percent.",
    "Введите инструмент": "Enter an instrument",
    "Например:": "Example:",
    "Частота сохранена:": "Frequency saved:",
    "Порог сохранён:": "Threshold saved:",
    "Не получилось:": "Could not save:",
    ...
    "Страница": "Page",
    "Положительный фандинг": "Positive funding",
    "Отрицательный фандинг": "Negative funding",
    "Нет данных": "No data",
    "Проверка фандинга": "Funding check",
    ...
    "API временно недоступен": "API temporarily unavailable",
    "контракт не найден": "contract not found",
    "ставка недоступна": "rate unavailable",
    "Настройки FVG 15м": "FVG 15m settings",
    "Модуль:": "Module:",
    "Подтверждённые:": "Confirmed:",
    "Пред-FVG за 3 минуты:": "Pre-FVG 3 minutes early:",
    "Бычьи:": "Bullish:",
    "медвежьи:": "bearish:",
    "Инструменты:": "Instruments:",
    ...
    "Отправлено уведомлений пользователям:": "User notifications sent:",
    "FVG-события": "FVG events",
    "всё время": "all time",
    "дней": "days",
    ...
    "Направление": "Direction",
    "Зона FVG": "FVG zone",
    "Размер зоны": "Zone size",
    "Цена сигнала": "Signal price",
    "Время C": "C time",
    "Статус": "Status",
    "Предварительный сигнал: свеча C ещё не закрыта": "Preliminary signal: candle C is not closed yet",
    "Подтверждён закрытием свечи C": "Confirmed by candle C close",
    "Возможный бычий FVG": "Possible bullish FVG",
    "Возможный медвежий FVG": "Possible bearish FVG",
    "Подтверждённый бычий FVG": "Confirmed bullish FVG",
    "Подтверждённый медвежий FVG": "Confirmed bearish FVG",
    "Бычий": "Bullish",
    "Медвежий": "Bearish",
    "Фандинг пересёк заданный порог": "Funding crossed the configured threshold",
    "Продолжение уведомления о фандинге": "Funding alert continued",
    "Выбери инструмент": "Select an instrument",
    "Сначала добавь инструмент командой": "First add an instrument with",
    ...
    "Диапазон": "Range",
    "Все остальные настройки меняются кнопками ниже.": "All other settings are changed with the buttons below.",
    "Попробуй ещё раз или /cancel.": "Try again or use /cancel.",
    "Админ-настройки": "Admin settings",
    "Публичный доступ включён.": "Public access enabled.",
    "Приватный доступ включён.": "Private access enabled.",
    ...
    "Без имени": "Unnamed",
    "WebSocket Bitunix": "Bitunix WebSocket",
    "подключён": "connected",
    "отключён": "disconnected",
    "неизвестно": "unknown",
    "Последняя свеча": "Last candle",
    "Последний REST recovery": "Last REST recovery",
    "Последняя ошибка": "Last error",
    "Очередь уведомлений": "Notification queue",
    "Сообщений в outbox": "Messages in outbox",
    "Успешных доставок": "Successful deliveries",
    "Ошибок доставки": "Delivery failures",
    "Повторных доставок": "Delivery retries",
    "Навсегда отклонено Telegram": "Permanently rejected by Telegram",
    "Состояние баз данных": "Database status",
    ...
    "Версия установленного релиза": "Installed release version",
    "Версия": "Version",
    "не записан": "not recorded",
    ...
    "Язык изменён.": "Language updated.",
    "Формат уведомлений изменён.": "Alert format updated.",
    "Нижнее меню обновлено.": "Bottom menu updated.",
    "мин.": "min",
    "ч.": "h",
}
...
def _compact_funding(text: str, language: str) -> str:
    ...
    header = (
        f"🔔 Funding alert · threshold {threshold}"
        if language == "en"
        else f"🔔 Фандинг · порог {threshold}"
    )
...
def localize_text(text: str, language: str, mode: str = "detailed") -> str:
    ...
    is_funding = (
        "Фандинг пересёк заданный порог" in text
        or "Funding crossed the configured threshold" in text
        or "Продолжение уведомления о фандинге" in text
    )
