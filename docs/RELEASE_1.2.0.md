...
Кодовый состав релиза подтверждён успешным GitHub-hosted аудитом PR #45; последующий docs-only push используется только для запуска уже установленного в `main` workflow публикации.
